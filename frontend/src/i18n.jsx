  ...
  en: {
    ...
    settings: {
      ...
      telegram: {
        ...
        detectedByBrowser: 'Detected by browser',
...
MESSAGES.ru.settings.telegram = {
  ...
  detectedByBrowser: 'Определён браузером',
  savedManually: 'Сохранён вручную',
  useBrowserTimezone: 'Использовать часовой пояс браузера',
